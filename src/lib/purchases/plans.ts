...
export const purchasePlans = [
  { additionalLimit: 10, amount: 990, kind: 'capacity', label: '친구 그림 10명 추가', productId: 'FRIENDS_10' },
  ...
  { additionalLimit: 0, amount: 990, kind: 'watermark', label: '워터마크 제거', productId: 'WATERMARK_FREE' },
