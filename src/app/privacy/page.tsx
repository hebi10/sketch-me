      ...
      <article className="legal-document">
        ...
        <section id="privacy-items">
          ...
          <dl className="legal-data-list">
            ...
            <div>
              <dt>보안 정보</dt>
              <dd>요청 IP는 생성·제출 횟수 제한을 위해 서버 메모리에서 최대 1시간 처리합니다. 친구 그림의 스케치북별 제출 횟수를 제한하기 위해 IP를 복원하기 어려운 해시로 변환해 스케치북 삭제 시까지 저장할 수 있으며 IP 원문은 저장하지 않습니다. 관리 로그인 실패 시 접속정보를 해시한 값과 실패 횟수를 스케치북 삭제 시까지 저장할 수 있습니다.</dd>
            </div>
          </dl>
        ...
        <section id="privacy-retention">
          ...
          <ul>
            ...
            <li>IP 기반 요청 제한 정보: 단기 제한 정보는 서버 메모리에서 최대 1시간, 스케치북별 친구 그림 제출 횟수 해시는 해당 스케치북 삭제 시까지</li>
          </ul>
