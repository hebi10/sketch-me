    ...
    <main className="legal-shell">
      ...
      <article className="legal-document">
        ...
        <section id="privacy-items">
          ...
          <p>입력한 관리용 비밀번호 원문은 서버에 저장하지 않습니다. 생성 중에는 현재 페이지 메모리에서만 처리하며, 페이지를 새로고침하거나 탭을 닫으면 사라집니다.</p>
        </section>
        ...
        <section id="privacy-retention">
          ...
          <ul>
            ...
            <li>계약 또는 청약철회 기록: 5년, 대금결제 및 재화 공급 기록: 5년 동안 관계 법령에 따라 보관합니다.</li>
            <li>이메일 등 문의 채널로 접수된 소비자 불만 또는 분쟁처리 기록: 처리 완료일로부터 3년 동안 보관합니다. 법정 보관 대상이 아닌 일반 문의는 처리 목적 달성 후 지체 없이 삭제합니다.</li>
        ...
        <section id="privacy-transfer">
          ...
          <ul className="legal-location-list">
            ...
            <li>Cloud Storage for Firebase: 그림·사진 저장, 미국 사우스캐롤라이나(us-east1)</li>
        ...
        <section id="privacy-storage">
          ...
          <p>생성 화면의 입력 유실을 줄이기 위해 이름, 비밀번호 힌트와 직접 그린 그림 초안만 sessionStorage에 임시 저장합니다. 관리용 비밀번호와 비밀번호 확인값은 브라우저 저장소에 저장하지 않습니다.</p>
        </section>
