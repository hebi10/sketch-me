      ...
      <article className="legal-document">
        ...
        <section id="privacy-purpose">
          ...
          <ul>
            ...
            <li>모의 결제에 따른 참여 가능 인원·워터마크 제거 권한과 구매 기록 관리</li>
        ...
        <section id="privacy-items">
          ...
          <dl className="legal-data-list">
            ...
            <div>
              <dt>친구 그림 제출</dt>
              <dd>작성자의 이름 또는 애칭, 그림, 선택한 한마디, 참고 사진 사용 여부와 제출 시각을 처리합니다. 제출 그림은 보관용 원본과 갤러리용 320px WebP 썸네일을 별도로 생성해 저장합니다.</dd>
            </div>
            <div>
              <dt>모의 결제</dt>
        ...
        <section id="privacy-retention">
          <h2>보유 기간과 파기</h2>
          <ul>
            <li>스케치북, 보관용 그림·갤러리 썸네일, 사진, 한마디와 모의 구매 기록: 스케치북을 삭제할 때까지</li>
