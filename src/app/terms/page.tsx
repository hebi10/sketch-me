...
export const metadata: Metadata = {
  ...
  description: '스캐치북의 서비스 이용, 모의 결제, 유료 상품 보장 및 서비스 종료 정책입니다.',
};
      ...
      <article className="legal-document">
        ...
        <section id="payment">
          ...
          <ul>
            ...
            <li>친구 그림 50명 추가 · 3,900원</li>
            <li>친구 그림 100명 추가 · 6,900원</li>
          </ul>
          <p><strong>현재는 실제 금액이 청구되지 않는 모의 결제입니다.</strong> 모의 결제로 추가된 인원에는 실제 결제·환불 채권이 발생하지 않습니다. 실제 결제 기능을 연결할 때 결제수단, 청약철회 및 환불 조건을 결제 전에 다시 명확히 안내합니다.</p>
        </section>

        <section id="guarantee">
          <h2>3. 추가 인원과 이용 보장</h2>
          <p><strong>구매한 추가 인원은 서비스 운영 중 만료되지 않습니다.</strong> 실제 결제가 연결되면 구매일로부터 최소 1년간 서비스 이용을 보장합니다.</p>
